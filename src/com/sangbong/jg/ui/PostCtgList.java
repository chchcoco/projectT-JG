 ...
 * <pre>
 * Class : PostCtgList
 * Comment : 선택한 카테고리별 게시판 조회 화면 구현 
 * History
 ...
 * @see 
 * */
public class PostCtgList extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PostCtgList frame = new PostCtgList();
	...
	public PostCtgList() {
		...
		JLabel juniorCategoryLabel = new JLabel("> 선택한 하위 카테고리명");
